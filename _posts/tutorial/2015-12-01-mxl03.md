...
| complex identifier | `'<identifier with special character>'`                                 | SocioCortex allows identifiers with special characters (e.g., entity type or attribute names with whitespaces). When referring to those elements, their names have to be enclosed by single quotation marks (').                                                                                                                                                                    | `'Operand 1' + op2 * 'Operand 3'`                                                            |
